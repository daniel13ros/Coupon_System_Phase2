...
public class ServiceTest implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        BeautifyUtil.title("Update coupon 1");
        System.out.println(coupon1+" before");
        coupon1.setCategory(Category.Gifts);
        companyService1.updateCoupon(1, coupon1, coupon1.getId());
        System.out.println(coupon1+" after");
